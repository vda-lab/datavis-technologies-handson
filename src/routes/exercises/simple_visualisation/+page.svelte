...
<h3>Exercise 15</h3>
<p>For this exercise, you have to edit the file <code>src/routes/simple_visualisation/Ex15.svelte</code>. Any changes you make to that file should show up below.</p>
