...
<Code
  ...
  $: console.log(\`Repeated every time value changes: \$\{value\}\`);
</\script>`}
/>
<p>
...
<p>
  ...
  Use the <CC code="points" /> array as x-coordinates of the circle elements and
  ...
  <em
    >Hint: remember how we loaded data only when a component was first rendered
    in Exercise 21!</em
  >
</p>
