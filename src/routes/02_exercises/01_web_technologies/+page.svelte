...
<p>
	In this first set of exercises, we will look in the fundamentals of developing
	for the web, i.e. HTML, CSS and javascript.
</p>
<p>
	The setup that we are using here is a <i>little</i> different from generic HTML/CSS/js
	because we want to organise everything within the same codebase.
</p>
<p>
	...
	Components are implemented in <CC code=".svelte" /> files, which contain three
...
<p>
	...
	above, we printed the string in the variable <code>world</code> into the <CC
		language="html"
		code="<p></p>"
	/> tags. Svelte will automatically update the value in the <CC
		language="javascript"
		code="world"
	/> into the <CC language="html" code="<p></p>" /> tags when the value of the variable
	changes.
</p>
