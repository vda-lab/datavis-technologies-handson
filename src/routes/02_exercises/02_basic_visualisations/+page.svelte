...
using Svelte. We will show some key <a href="http://d3js.org">d3.js</a>
...
<a href="https://github.com/d3/d3-scale">scales</a>,
<a href="https://github.com/d3/d3-scale-chromatic">colors</a>, and
<a href="https://github.com/d3/d3-axis">axes</a>
...
<h3>Exercise 15</h3>
<p>
	For this exercise, you have to edit the file <code
		>src/routes/simple_visualisation/Ex15.svelte</code
...
<p>
	...
	circles, rectangles, and lines. SVG is very usefull for custom visualizations,
...
<p>
	...
	legends. In the example, we defined the <code>margin</code> variable which
	specifies how much space should be reserved on each side. The margins are
	coloured dark-blue while the content-area is light-blue. As you can see, the
	content-area's origin has moved away from the SVG element's origin. In
	addition, its width and height have shrunk. The <code>innerWidth</code> and
	<code>innerHeight</code>
	variables compute the new size of the content-area and we used a grouping (<code
		>g</code
	>) tag that specifies the translation of the content-area's origin. This means
	that, when you are mapping data to the content-area, the x- and y-coordinates
	range from 0 to <code>innerWidth</code> and <code>innerHeight</code>,
	respectively.
</p>
